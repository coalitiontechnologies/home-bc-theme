...
$GLOBALS['TPL_CFG']['Name'] = 'Home Theme';
...
$GLOBALS['TPL_CFG']['Partner'] = array(
    'Name' => '',
//    'Contact' => 'http://www.example.com/support/',
    'Email' => 'joshc@coalitiontechnologies.com',
);
...
$GLOBALS['TPL_CFG']['SlideShowWidth'] = 960;
$GLOBALS['TPL_CFG']['SlideShowHeight'] = 400;
...
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesStorewideThumbnail_width']       = 295;
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesStorewideThumbnail_height']      = 260;
...
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesProductPageImage_height']      = 660;
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesProductPageImage_timeChanged'] = time();

$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesGalleryThumbnail_width']       = 70;
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesGalleryThumbnail_height']      = 70;
...
$GLOBALS['TPL_CFG']['DemoStore'] = "http://home-theme-demo.mybigcommerce.com";

// Is theme enabled? (i.e. visible in Theme Store)
$GLOBALS['TPL_CFG']['Enabled'] = Store_Feature::isEnabled('HomeThemeTheme');
